        ...
        var methods = {
            ...
            jqipslide2page: function(page, effect) {
                ...
                if (workData.initIphoneSlide) {
                    ...
                    workspace.data("workData", $.extend({},
                    workData, {
                        "nowPage": page
                    }));
                    ...
                    if (effect) {
                        $(handler).animate(__animate.after, 300, ($.easing[opts.easing] !== undefined ? opts.easing: "swing"),
                        function() {
            ...
            jqipblank2page: function(content, jump2page, callback) {
                ...
                callback = (typeof jump2page === "function") ? jump2page: (typeof callback === "function") ? callback: function() {
                    return false;
                };
            ...
            init: function(options, callback) {
                ...
                return $(this).each(function() {
                    ...
                    workspace.bind("slideComplete.jqiphoneslide",
                    function(event) {
                    ...
                    var __slideNextPage = function(event) {
                        ...
                        if (nowPage <= totalPages) {
                            ...
                            handler.animate(__animate.after, 300, ((opts.bounce && $.easing[opts.easing] !== undefined) ? opts.easing: "swing"),
                            function() {
                    ...
                    var createPager = function() {
                        ...
                        $("li", pagerHtml).bind("click.pagerLink",
                        function(event) {
                    ...
                    var __mouseDown = function(event) {
                        ...
                        startEventData = moveEventData = $.extend({},
                        __startEvent, {
                    ...
                    var __mouseUp = function(event) {
                        ...
                        Math.abs(__mouseDownEvent.pageY - __eventTouches.pageY)
                            ...
                            handler.animate(__animate.after, during, ($.easing[opts.easing] !== undefined ? opts.easing: "swing"),
                            function() {
                                __mouseStarted = false;
                                workspace.trigger({
                                    type: "slideComplete",
                            ...
                            handler.css({
                                'top': dragAndDrop.origY,
                                'left': dragAndDrop.origX
                            });
